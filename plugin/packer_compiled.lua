...
_G.packer_plugins = {
  ...
  ["nvim-web-devicons"] = {
    ...
    config = { "\27LJ\2\n1\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\22nvim-web-devicons\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "C:\\Users\\Arjun\\AppData\\Local\\nvim-data\\site\\pack\\packer\\opt\\nvim-web-devicons",
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nui.nvim', 'gitsigns.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
